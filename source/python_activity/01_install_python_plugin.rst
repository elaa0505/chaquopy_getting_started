...
.. image:: /images/python_activity/01_install_python_plugin/01_menu.png

---------------------------------------------------------------------------------------------------

Navigate to the ``Plugins`` sections & click ``Install JetBrains plugin...``.

.. image:: /images/python_activity/01_install_python_plugin/02_plugins.png

---------------------------------------------------------------------------------------------------

Type ``Python Community Edition`` in the search field, select the plugin, & click ``Install``.

.. image:: /images/python_activity/01_install_python_plugin/03_install.png

---------------------------------------------------------------------------------------------------

When the plugin is finished installing, click ``Restart Android Studio``

.. image:: /images/python_activity/01_install_python_plugin/04_restart.png
